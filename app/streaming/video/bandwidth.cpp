...
{
public:
    static bool getNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent);

private:
#ifdef Q_OS_WIN
    static bool getWindowsNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent);
#elif defined(Q_OS_LINUX)
    static bool getLinuxNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent);
#elif defined(Q_OS_DARWIN)
    static bool getMacOSNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent);
#endif
};
...
// 系统网络统计实现
bool SystemNetworkStats::getNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent)
{
#ifdef Q_OS_WIN
...
#ifdef Q_OS_WIN
bool SystemNetworkStats::getWindowsNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent)
{
    // 初始化计数器
    bytesReceived = 0;
    bytesSent = 0;
...
#elif defined(Q_OS_LINUX)
bool SystemNetworkStats::getLinuxNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent)
{
...
#elif defined(Q_OS_DARWIN)
bool SystemNetworkStats::getMacOSNetworkUsage(quint64 &bytesReceived, quint64 &bytesSent)
{
